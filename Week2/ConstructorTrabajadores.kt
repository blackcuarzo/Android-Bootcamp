...
class Trabajadores {
    private val gerente = Trabajador("Gerente", pagoHora = 200)
    private val operador = Trabajador("Operador", pagoHora = 10)
    private val contador = Trabajador("Contador", pagoHora = 50)
    init {
